  ...
  public static class SendEmail
  {
    ...
    public static void SendEmailUsingLeavON(Leave leave1, string LeavON_Email, string LeavON_Password, AspNetUser sender, AspNetUser receiver, String MessageType)
    {
      ...
      try
      {
        ...
        emailTemplate = emailTemplate.Replace("<%EmpName%>", "");
        emailTemplate = emailTemplate.Replace("<%Status%>", "");
        emailTemplate = emailTemplate.Replace("<%EmpNo%>", "");
        emailTemplate = emailTemplate.Replace("<%Dept%>", "");
        emailTemplate = emailTemplate.Replace("<%Purpose%>", "");
        emailTemplate = emailTemplate.Replace("<%LineManager%>", "");
        emailTemplate = emailTemplate.Replace("<%EmergencyContact%>", "");
        emailTemplate = emailTemplate.Replace("<%Location%>", "");
        emailTemplate = emailTemplate.Replace("<%FromDate%>", "");
        emailTemplate = emailTemplate.Replace("<%ToDate%>", "");
        emailTemplate = emailTemplate.Replace("<%LoggedInUser%>", "");
